...
\input{./src/task3/singular_points.tex}
% \subsection{Im(z) и Re(z)}
\input{./src/task3/im_re.tex}
% \subsection{Точка}
\input{./src/task3/point.tex}
% \subsection{Координатная сетка}
\input{./src/task3/grid.tex}
% \subsection{Геометрические фигуры}
\input{./src/task3/figures.tex}
% \subsection{Обратное преобразование}
\input{./src/task3/inverse.tex}
% \subsection{Показатель преломления}
\input{./src/task3/refractive_index.tex}
